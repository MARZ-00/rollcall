<html lang="en">
  ...
  <body>
    ...
    <table>
      ...
      $sql = "SELECT namaPelajar, status, kelas, tarikh, photo FROM checklistpelajar";
      ...
      if ($result->num_rows > 0) {
          while ($row = $result->fetch_assoc()) {
              ...
              echo "<td><img src='data:image/jpeg;base64," . base64_encode($row['photo']) . "' width='130' height='100'/></td>";
              echo "</tr>";
              $serialNumber++;
          }
      } else {
